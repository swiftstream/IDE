...
export enum SideTreeItem {
	...
	GradleLibrary = 'GradleLibrary',
		GradleLibGenerate = 'GradleLibGenerate',
		GradleLibGenerateGradleW = 'GradleLibGenerateGradleW',
		GradleWLibAssemble = 'GradleWLibAssemble',
	GradleApp = 'GradleApp',
		GradleAppGenerate = 'GradleAppGenerate',
		GradleAppGenerateGradleW = 'GradleAppGenerateGradleW',
		GradleWAppAssemble = 'GradleWAppAssemble',
	ADB = 'ADB',
		ADBMode = 'ADBMode',
